...
import { LayoutDashboard, Building2, MessageSquare, Users, FileText, ImageIcon, Layers, Settings, LogOut, ShieldCheck, ShieldAlert, BadgeCheck, AlertTriangle, Crown, Tags, Bot } from "lucide-react";
    ...
    <div className="min-h-screen bg-canvas flex">
      <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-card border-r border-rule sticky top-0 h-screen">
        ...
        <nav className="flex-1 p-3 space-y-1 text-[13.5px]">
          ...
          <NavItem to="/admin/bot" icon={Bot} label="Complaint Bot" />
